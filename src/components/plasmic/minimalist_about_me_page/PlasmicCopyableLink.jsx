...
import * as sty from "./PlasmicCopyableLink.module.css"; // plasmic-import: rOODi4RGgXYkp/css
...
function PlasmicCopyableLink__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(defaultcss.all, sty.box__l3GQ6)}>
          {p.renderPlasmicSlot({
